...
Begin VB.Form frmAbout 
   ...
   Begin VB.Image imgIcono 
      Height          =   1335
      Left            =   120
      Picture         =   "frmAbout.frx":400A
      Stretch         =   -1  'True
      Top             =   120
      Width           =   1770
   End
   Begin VB.Label lbldescrip 
      Caption         =   "Modulo de solicitud de mercancia, confirmacion y recepcion de pedidos, tambien incluye opciones para realizar traslados"
      Height          =   615
      Left            =   2280
      TabIndex        =   7
      Top             =   1680
   ...
   Begin VB.Label lblSistema 
      Caption         =   "Sistema Integral pitico"
      Height          =   255
      Left            =   240
      TabIndex        =   6
      Top             =   3000
